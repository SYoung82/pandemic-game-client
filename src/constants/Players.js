export const players = [
    {id: 1, name: 'Player 1', role: 'Medic', color: 'orange', currentPlayer: true, movesLeft: 4, currentCity: 'Atlanta', hand: [{name: 'Lagos', color: 'yellow', population: 11547000, type: 'city'},
    ...
    {id: 2, name: 'Player 2', role: 'Contingency Planner', color: 'dark green', currentPlayer: false, movesLeft: 4, currentCity: 'Atlanta', hand: [{name: 'Sao Paulo', color: 'yellow', population: 20186000, type: 'city'},
