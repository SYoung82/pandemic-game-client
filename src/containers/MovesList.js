    ...
    render() { 
        return (
            <div>
                ...
                <CureDiseaseLinks currentPlayer={this.props.currentPlayer} currentCity={this.props.currentCity} hand={this.props.currentPlayer.hand} diseaseStatus={this.props.diseaseStatus} playerDeck={this.props.playerDeck} />
